...
class Parking(models.Model):
    ...
    car_plate = models.CharField(max_length=50, null=False, blank=False,
                                 verbose_name="车牌号")
    parking_status = models.CharField(choices=(('in', '停车中'), ('out', '已离开')),
                                      max_length=10, default='in',
                                      verbose_name='停车状态')
    order_no = models.BigIntegerField(null=True, blank=True, verbose_name='订单号')
    in_time = models.DateTimeField(auto_now_add=True, verbose_name='进入时间')
    out_time = models.DateTimeField(null=True, blank=True, verbose_name='离开时间')
